...
export default function TabelaEntregador(props) {
    function deleteDeliveryMan(entregador) {
        if (window.confirm("Deseja realmente excluir o entregador: " + entregador.nome + "?")) {
            props.setListaEntregadores(props.listaDeEntregadores.filter((aux) => {
                return aux.id !== entregador.id;
            }))
        }
    }
                            ...
                            props.listaDeEntregadores?.map((entregador) => {
                                return (
                                    <tr>
                                        ...
                                        <td><img width={100} height={100} src={entregador.cnh} alt="Imagem da CNH" /></td>
