...
import { apagarProduto, buscarProdutos } from "../../../redux/produtoReducer";
import ESTADO from "../../../redux/estados";
import { useEffect } from "react";

export default function TabelaProdutos(props) {
  //recuperar o estado da aplicação / fatia produto
  const { estado, mensagem, listaDeProdutos } = useSelector(
    (state) => state.produto
  );
    ...
    return (
      <>
        <Container>
          ...
          <p>
            Quantidade de produtos cadastrados: {listaDeProdutos.length}
          </p>
        </Container>
      </>
    );
